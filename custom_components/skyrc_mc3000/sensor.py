...
DEVICE_SENSORS: tuple[SkyrcSensorDescription, ...] = (
    ...
    SkyrcSensorDescription(
        ...
        value_fn=lambda basic: _enum_name(getattr(basic, "temp_unit", None)),
    ),
    SkyrcSensorDescription(
        key="display_mode",
        name="Display Mode",
        ...
        state_class=None,
        icon="mdi:monitor",
        value_fn=lambda basic: _enum_name(getattr(basic, "display", None)),
    ),
    SkyrcSensorDescription(
        ...
        state_class=None,
        icon="mdi:fan",
        value_fn=lambda basic: _enum_name(getattr(basic, "cooling_fan", None)),
    ),
    SkyrcSensorDescription(
        key="system_beep",
        name="System Beep",
        ...
        value_fn=lambda basic: getattr(basic, "system_beep", None),
    ),
    SkyrcSensorDescription(
        key="screensaver",
        name="Screensaver",
        ...
        value_fn=lambda basic: getattr(basic, "screensaver", None),
    ),
)
